...
train_data_dir = 'cricketers/training_set'
validation_data_dir = 'cricketers/testing_set/'
...
classifier = load_model('recog.h5')
...
face_recog_dict = {"[0]": "MS_Dhoni ", 
                      "[1]": "Shikhar_Dhawan",
                      "[2]": "Virat_Kohli",
                     }
face_recog_dict_n = {"ms_dhoni": "MS_Dhoni ", 
...
for i in range(0,10):
    input_im = getRandomImage("cricketers/testing_set/")
